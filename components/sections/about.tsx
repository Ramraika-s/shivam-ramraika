  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        >
          <h3 className={`text-xl font-bold ${theme === 'day' ? 'text-black' : 'text-white'} mb-4 flex items-center`}>
            <Code className="mr-2" /> Technical Skills
          </h3>
          <ul className={`list-disc list-inside ${theme === 'day' ? 'text-black' : 'text-white'} space-y-2`}>
